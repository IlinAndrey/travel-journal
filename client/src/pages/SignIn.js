        ...
        <div className="container">
            <div className="d-flex justify-content-center">
                <div className="card p-4 m-4 bg-white rounded-sm col-12 col-sm-6 col-lg-5">
                    <h5 className="fs2 mx-auto">Войдите чтобы продолжить</h5>

                    {alertMessage && <div className="mt-1 col-12 mx-auto">
                        {alertMessage.success===true ? <div>
                            <div class="alert alert-success alert-dismissible fade show" role="alert">
                                <strong>Добро пожаловать! Вы вошли.</strong>
                    ...
                    <form onSubmit={LogIn}>
                        ...
                        {loading===false ? <button type="submit" class="btn btn-primary shadow-none outline-none border-0 w-100 rounded-pill">Войти</button>
                            : <button className="btn btn-primary shadow-none text-white outline-none border-0 w-100 rounded-pill" disabled>Загрузка...</button>
                        }
                    </form>
                    <div className="d-flex justify-content-center small text-muted mt-2">или</div>
                            {/* <a role="button" href={GOOGLE_OAUTH_URI} className="btn btn-secondary shadow-none outline-none border-0 w-100 mt-2 rounded-pill">
                                ...
                                <span className="ms-2">Продолжить с Google</span>
                            </a> */}
                            <div className="small text-muted mt-3">Нет аккаунта?{" "}
